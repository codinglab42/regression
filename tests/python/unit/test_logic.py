...
try:
    ...
    model = ml.models.LinearRegression(0.01, 1000, 0.0, ml.LinearSolver.GRADIENT_DESCENT)
    ...
    lr = ml.models.LinearRegression(learning_rate=0.01, max_iter=1000)
    lr.fit(X, y)
    ...
    logr = ml.models.LogisticRegression(learning_rate=0.1, max_iter=1000)
